...
public class MarketPet extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_market_pet);
...
//                                photoView.setImageBitmap(decodedImageBitMap);)
                ...
                fireBaseRef.child("pets/Sell").addChildEventListener(new ChildEventListener() {
                    @Override
...
//                        count = dataSnapshot.getChildrenCount();
                ...
                fireBaseRef.child("pets/Buy").addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        Log.e("MarketPet", "Snapshot Value is:" + dataSnapshot.getValue());
                        Log.e("MarketPet","dataSnapshot.getChildrenCount():"+dataSnapshot.getChildrenCount());
                        Log.e("MarketPet","dataSnapshot.getChildren():"+dataSnapshot.getChildren());
                        int childCount=0;
                        MarketData marketItem = new MarketData("","","","");
                        String description= "",imagePath = "",marketCategory= "",title ="";
                        for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
...
//                        count = dataSnapshot.getChildrenCount();
                ...
                fireBaseRef.child("pets/Lend").addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        int childCount=0;
                        MarketData marketItem = new MarketData("","","","");
...
//                        count = dataSnapshot.getChildrenCount();
                ...
                fireBaseRef.child("pets/Nannies").addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        //Getting Object from FireBase through DataSnapShot
                        int childCount=0;
...
//SPINNER------------------------------------------
        ...
        array_spinner[1]="Buy";
        array_spinner[2]="Sell";
        array_spinner[3]="Lend";
        Log.e("MarketPet","ItemDescription is "+itemDescription);
        Log.e("MarketPet","Title is "+title);
...
//                      Log.e("MarketPet", "Last Item in the List:" + marketForumItems.get(marketForumItems.size() - 1).toString());
                        ...
                        String imageEncodedBase64 = Base64.encodeToString(b, Base64.DEFAULT);
